"This script is used to transform the dataset from 10.1021/acs.jcim.0c00195 to sdf file so it can be processed further."
import pandas as pd
...
data = pd.read_pickle("../raw_data/NMR_data_13C.pickle")
train = data["train_df"]
